...
This library now supports **React Native's New Architecture** (Fabric & TurboModules)!

- ✅ Full backward compatibility with legacy bridge
- ✅ TurboModules for better performance
- ✅ Type-safe native module interfaces
- ✅ Works with React Native 0.71+

See [NEW_ARCHITECTURE.md](./NEW_ARCHITECTURE.md) for migration details.
...
（管理者のみ）develop ブランチのバージョン更新して、main ブランチへ PR を作ってください。マージを行うと、自動で npm にリリースされます。
